...
function injectArmoryPolishStyles() {
  ...
  style.textContent = `
    /* ---------------------------------------------------------
       WAR REALMS ARMORY — compact catalog + modern filters
       --------------------------------------------------------- */
    ...
    body.armoryMode:not(.deckBuilderMode) .catalogGrid.storeCatalogGrid:empty {
      padding-bottom: 0;
    }
    ...
    body.armoryMode:not(.deckBuilderMode) .armoryToolbar {
      ...
      background:
        linear-gradient(180deg, rgba(15, 23, 33, .98), rgba(9, 15, 23, .96));
    ...
    body.armoryMode:not(.deckBuilderMode) .armorySearchRow .searchWrap {
      position: relative;
    }
    ...
    .filterCheck input[type="checkbox"]::after,
    .filterToggle input[type="checkbox"]::after {
      content: "✓";
      transform: scale(0);
      color: #11151a;
      font-size: 11px;
    ...
    .filterToggle input[type="checkbox"]:checked {
      border-color: #e1c44e;
      background: #e1c44e;
      box-shadow: 0 0 0 3px rgba(225, 196, 78, .1);
    }

    .filterCheck input[type="checkbox"]:checked::after,
    .filterToggle input[type="checkbox"]:checked::after {
      transform: scale(1);
    }

    .filterCheck:has(input:checked),
    .filterToggle:has(input:checked) {
      border-color: #6a7883;
    ...
    .filterFieldGrid select,
    .filterFullField select,
    .filterRange input {
      min-height: 37px;
      border-color: #34475a;
      border-radius: 9px;
    ...
    .filterFieldGrid select:hover,
    .filterFullField select:hover,
    .filterRange input:hover {
      border-color: #4e657c;
      background: #111c27;
    }

    .filterFieldGrid select:focus,
    .filterFullField select:focus,
    ...
    .filterDrawerFoot .btn.primary,
    .filterDrawerFoot .btn.good {
