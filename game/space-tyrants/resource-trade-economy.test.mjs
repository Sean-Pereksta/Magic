...
test("declining a routine requested-trade offer has no relationship penalty",()=>{
  const {state,api}=createHarness(),request=api.requestTrade("components",50),offer=state.resourceTradeEconomy.offers.find(o=>o.requestId===request.id),before=state.empires[0].relations[offer.from]||0;
