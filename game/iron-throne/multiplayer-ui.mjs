...
export class MultiplayerUI {
  ...
  render(status,state){
    ...
    document.getElementById('save-status').textContent=online?`Online campaign saved · turn ${meta.turn}`:'RECONNECTING… Orders paused';
  }
}
