...
import { PLAYER, build, buildCheck, buildHighway, createGame, declareWar, economyProjection, kingdom, mergeArmies, parseSave, recruit, resolveEconomy, resolveMovement, settlements, splitArmy, strategyTurn } from '../core.mjs';
