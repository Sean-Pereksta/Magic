...
import { PLAYER, atWar, build, buildCheck, canEnter, declareWar, kingdom, parseSave, relation, resolveEconomy, resolveMovement, settlements, strategyTurn } from '../core.mjs';
